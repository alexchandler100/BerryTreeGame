...
var Keyboard = new Phaser.Class({
  ...
  preload: function() {
    this.load.audio('metronome1', 'assets/audio/metronome1.wav');
    this.load.audio('metronome2', 'assets/audio/metronome2.wav');
    this.load.audio('hiphopdrums1', 'assets/audio/hiphopdrums1.wav');
    this.load.audio('middleC', 'assets/audio/piano_middle_c.wav');
    this.load.audio('wurlmiddleC', 'assets/audio/wurlitzer_middle_c.wav');
    this.load.audio('bassmiddleC', 'assets/audio/bass_middle_c.wav');
    this.load.audio('choirmiddleC', 'assets/audio/choir_middle_c.wav');
    this.load.audio('clavmiddleC', 'assets/audio/clav_middle_c.wav');
    this.load.audio('guitarmiddleC', 'assets/audio/guitar_middle_c.wav');
    this.load.audio('stringsmiddleC', 'assets/audio/strings_middle_c.wav');
    this.load.audio('hihat1', 'assets/audio/hihat1.wav');
    this.load.audio('openhihat1', 'assets/audio/openhihat1.wav');
    this.load.audio('hihat2', 'assets/audio/hihat2.wav');
    this.load.audio('kick1', 'assets/audio/kick1.wav');
    this.load.audio('kick2', 'assets/audio/kick2.wav');
    this.load.audio('shaker1', 'assets/audio/shaker1.wav');
    this.load.audio('shaker2', 'assets/audio/shaker2.wav');
    this.load.audio('snare1', 'assets/audio/snare1.wav');
    this.load.audio('snare2', 'assets/audio/snare2.wav');
    this.load.audio('tambourine1', 'assets/audio/tambourine1.wav');
    this.load.audio('megamantom', 'assets/audio/megamantom.wav');
    this.load.image('motif6', 'assets/images/motif6big.png')
  },
  create: function() {
