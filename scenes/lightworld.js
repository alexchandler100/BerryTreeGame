...
update: function() {
  ...
  if (currentQuest === 'Jean Claude' || currentQuest === 'Jean Claude?') {
    ...
    gameState.questLocations["Girls Wanna Play Volleyball"]={x:volleyball.x, y:volleyball.y}
  ...
  gameState.questLocations['Beat Bennett in a Race']={x:bennett.x, y:bennett.y}
